...
<head>
    ...
    <title>Task Management||Completed Tasks</title>
</head>
<body>
<div class="container">
    <h1 class="mt-4 text-center">Task Management System</h1>
    <h3 class="mt-3 text-center">Completed Tasks List</h3>
        ...
        <table class="table table-bordered table-dark">
            ...
            @foreach ($data->sortByDesc(function ($item) {
                ...
                <tr>
                    ...
                    <td>{{ $item->duedate }}</td>
                    <td>
                        <form action="{{ route('remove.completetask', ['id' => $item->id]) }}" method="POST" style="display:inline">
                          @csrf
                          @method('DELETE')
